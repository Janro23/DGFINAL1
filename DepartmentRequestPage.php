...
<div class="sidenav">
  ...
  <a class="active" href="DepartmentRequestPage.php" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;"><img src="Assets/navicons/activerequest.png" alt="Request Icon">  Request</a>
...
<div class="titleheader">
  <h1 style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 30px; font-weight: bold; color: #4F4F4F">REQUEST FORM</h1>
</div>
