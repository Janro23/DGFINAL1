...
<div class="sidenav">
  ...
  <a class="active" href="table2.php" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;" ><img src="Assets/navicons/activeinventory.png" alt="Account creation Icon"> Inventory</a>    
    ...
    <h2 class="titleheader" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 30px; font-weight: bold; color: #4F4F4F">MANAGE INVENTORY</h2>
        <form method="POST"  action="additem2.php" enctype="multipart/form-data">
        ...
        <table class="table text-dark text-center table-striped table-hover table-bordered mt-4">
            ...
            <tbody>
                ...
                if ($filterDate) {
                    $sql .= " WHERE DATE(added_date) = '$filterDate'";  // Assuming 'added_date' column exists
                }
                ...
                <tr>
                    ...
                    <th>
                    <a href="edit2.php?id=<?php echo $row["product_id"] ?>" class="buttonblue">Edit</a>
                        <a href="delete2.php?id=<?php echo $row["product_id"] ?>" class="buttonred">Delete</a>
                    </th>
                </tr>
                <?php
                    }
